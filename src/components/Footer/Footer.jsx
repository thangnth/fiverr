          ...
          <div className={`${styles.footerTop} row`}>
            <div className={styles.topItem}>
              <article>
                ...
                <Collapse in={expandedSections[0]}>
            ...
            <div className={styles.topItem}>
              <article>
                ...
                <Collapse in={expandedSections[1]}>
                  <div className={styles.itemLink}>
                    <ul>
                      <li>
                        <a href="#">Careers</a>
            ...
            <div className={styles.topItem}>
              <article>
                ...
                <Collapse in={expandedSections[2]}>
                  <div className={styles.itemLink}>
                    <ul>
                      <li>
            ...
            <div className={styles.topItem}>
              <article>
                ...
                <Collapse in={expandedSections[3]}>
                  <div className={styles.itemLink}>
                    <ul>
                      <li>
                        <a href="#">Events</a>
            ...
            <div className={styles.topItem}>
              <article>
                ...
                <Collapse in={expandedSections[4]}>
                  <div className={styles.itemLink}>
                    <ul>
                      <li>
            ...
            <div className={styles.bottomRight}>
              ...
              <section className="d-flex">
                ...
                <button className={styles.accessibilityBtn}>
                  <span
                    className="XQskgrQ accessibility-icon"
